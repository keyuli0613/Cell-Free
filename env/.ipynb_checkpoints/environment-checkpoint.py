...
class MultiCellNetEnv(MultiAgentEnv):
    ...
    def get_reward(self, state):
        ...
        n_done = self.net._ue_stats[0,0]
        q_del = self.net.delay_ratio
        n_drop = self.net._ue_stats[1,0]
        q_drop = self.net.drop_ratio
        pc_kw = pc * 1e-3
    ...
    def info_dict(self):
        ...
        info.update(
            # bs1_pc = self._sim_steps and bs1_pc,
            # bs1_ue = self._sim_steps and bs1_ue,
